...
export const BASE_HK_COA: CoaTemplateAccount[] = [
  ...
  // ── Direct Costs (50000) ──
  { account_code: '50000', account_name: '直接成本 Direct Costs', account_type: 'cost', parent_code: null },
  { account_code: '51000', account_name: '服務成本 Cost of Services', account_type: 'cost', parent_code: '50000' },
  { account_code: '52000', account_name: '銷售成本 Cost of Sales', account_type: 'cost', parent_code: '50000' },
  { account_code: '51100', account_name: '外判及顧問費 Subcontractor & Consultant', account_type: 'cost', parent_code: '51000' },
  { account_code: '51200', account_name: '直接人工 Direct Labour', account_type: 'cost', parent_code: '51000' },
  { account_code: '51101', account_name: '外判工作費用 Subcontractor Fees', account_type: 'cost', parent_code: '51100' },
  { account_code: '51102', account_name: '專業顧問費 Professional Consultant', account_type: 'cost', parent_code: '51100' },
  { account_code: '51201', account_name: '項目人員薪酬 Project Staff Salary', account_type: 'cost', parent_code: '51200' },
...
export const INDUSTRY_ADDITIONS: Record<Industry, CoaTemplateAccount[]> = {
  ...
  trading: [
    ...
    { account_code: '52100', account_name: '購貨成本 Cost of Goods', account_type: 'cost', parent_code: '52000' },
    { account_code: '52101', account_name: '銷貨成本 Cost of Goods Sold', account_type: 'cost', parent_code: '52100' },
    { account_code: '52102', account_name: '運費及運輸 Freight & Shipping', account_type: 'cost', parent_code: '52100' },
    { account_code: '52103', account_name: '關稅 Customs Duties', account_type: 'cost', parent_code: '52100' },
    { account_code: '52104', account_name: '倉儲費 Warehousing', account_type: 'cost', parent_code: '52100' },
    { account_code: '52105', account_name: '港口及碼頭費 Port & Terminal Charges', account_type: 'cost', parent_code: '52100' },
    { account_code: '52106', account_name: '貨物保險 Cargo Insurance', account_type: 'cost', parent_code: '52100' },
  ...
  tourism: [
    ...
    { account_code: '52100', account_name: '購貨成本 Cost of Goods', account_type: 'cost', parent_code: '52000' },
    { account_code: '52101', account_name: '食材 Food Ingredients', account_type: 'cost', parent_code: '52100' },
    { account_code: '52102', account_name: '飲品供應 Beverage Supplies', account_type: 'cost', parent_code: '52100' },
    { account_code: '52103', account_name: '廚房用品 Kitchen Supplies', account_type: 'cost', parent_code: '52100' },
    { account_code: '52104', account_name: '包裝物料 Packaging Materials', account_type: 'cost', parent_code: '52100' },
    { account_code: '52105', account_name: '布草及洗滌 Linen & Laundry', account_type: 'cost', parent_code: '52100' },
  ...
  medical: [
    ...
    { account_code: '52101', account_name: '藥物成本 Pharmaceuticals COGS', account_type: 'cost', parent_code: '52100' },
    { account_code: '52102', account_name: '醫療耗材成本 Medical Consumables COGS', account_type: 'cost', parent_code: '52100' },
    { account_code: '52103', account_name: '化驗消耗品 Laboratory Consumables', account_type: 'cost', parent_code: '52100' },
  ...
  construction: [
    ...
    { account_code: '52101', account_name: '建築材料 Construction Materials', account_type: 'cost', parent_code: '52100' },
    { account_code: '52102', account_name: '分包商成本 Subcontractor Costs', account_type: 'cost', parent_code: '52100' },
    { account_code: '52103', account_name: '直接人工 Direct Labour', account_type: 'cost', parent_code: '52100' },
    { account_code: '52104', account_name: '機械租賃 Plant & Machinery Hire', account_type: 'cost', parent_code: '52100' },
    { account_code: '52105', account_name: '地盤費用 Site Costs', account_type: 'cost', parent_code: '52100' },
    { account_code: '52106', account_name: '安全設備 Safety Equipment', account_type: 'cost', parent_code: '52100' },
  ...
  ict: [
    ...
    { account_code: '52101', account_name: '硬件成本 Hardware COGS', account_type: 'cost', parent_code: '52100' },
    { account_code: '52102', account_name: '軟件授權成本 Software License COGS', account_type: 'cost', parent_code: '52100' },
    { account_code: '52103', account_name: '頻寬及互聯 Bandwidth & Peering', account_type: 'cost', parent_code: '52100' },
    { account_code: '52104', account_name: '電訊商互連 Carrier & Interconnection', account_type: 'cost', parent_code: '52100' },
    { account_code: '52105', account_name: '主機託管 Colocation Costs', account_type: 'cost', parent_code: '52100' },
  ...
  manufacturing: [
    ...
    { account_code: '52101', account_name: '原材料 Raw Materials', account_type: 'cost', parent_code: '52100' },
    { account_code: '52102', account_name: '直接人工 Direct Labour', account_type: 'cost', parent_code: '52100' },
    { account_code: '52103', account_name: '工廠間接費用 Factory Overhead', account_type: 'cost', parent_code: '52100' },
    { account_code: '52104', account_name: '工廠水電煤 Utilities - Factory', account_type: 'cost', parent_code: '52100' },
    { account_code: '52105', account_name: '包裝 Packaging', account_type: 'cost', parent_code: '52100' },
    { account_code: '52106', account_name: '品質控制及測試 Quality Control & Testing', account_type: 'cost', parent_code: '52100' },
    { account_code: '52107', account_name: '模具維修 Tooling & Mould Maintenance', account_type: 'cost', parent_code: '52100' },
    { account_code: '52108', account_name: '運輸及物流 Freight & Logistics', account_type: 'cost', parent_code: '52100' },
